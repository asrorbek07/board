...
public class ThumbUpRecordDoc extends StageEntityDoc {
    ...
    public ThumbUpRecordDoc(ThumbUpRecord thumbUpRecord) {
        ...
        if (thumbUpRecord.getActor() != null) {
            this.actorId = thumbUpRecord.getActor().getId();
            this.actorName = thumbUpRecord.getActor().getName();
        }
    }
    ...
    public ThumbUpRecord toDomain() {
        ...
        IdName actor = new IdName();
        actor.setId(actorId);
        actor.setName(actorName);
        thumbUpRecord.setActor(actor);
