...
public interface QnaBoardSeekFacade {
    /* Gen by Vizend Studio v5.1.0 */
    QueryResponse<Board> findQanBoard(FindQnaBoardQuery query);
    QueryResponse<List<Board>> findQanBoards(FindQnaBoardsQuery query);
}
