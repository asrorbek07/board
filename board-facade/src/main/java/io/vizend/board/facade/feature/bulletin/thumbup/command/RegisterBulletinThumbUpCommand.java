...
@NoArgsConstructor
@AuthorizedRole
public class RegisterBulletinThumbUpCommand extends CommandRequest {
    //
    ...
    public static RegisterBulletinThumbUpCommand fromJson(String json) {
        /*Gen by Vizend Studio v5.1.0*/
        return JsonUtil.fromJson(json, RegisterBulletinThumbUpCommand.class);
    }

    public static RegisterBulletinThumbUpCommand sample() {
        //
        BulletinThumbUpRecordCdo sample = BulletinThumbUpRecordCdo.sample();
        return new RegisterBulletinThumbUpCommand(
