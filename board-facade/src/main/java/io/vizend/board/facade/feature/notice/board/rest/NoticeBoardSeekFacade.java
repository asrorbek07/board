...
public interface NoticeBoardSeekFacade {
    /* Gen by Vizend Studio v5.1.0 */
    QueryResponse<Board> findNoticeBoard(FindNoticeBoardQuery query);
    QueryResponse<List<Board>> findNoticeBoards(FindNoticeBoardsQuery query);
}
