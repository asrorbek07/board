...
public class FindBulletinBoardQuery extends QueryRequest<Board> {
    ...
    public static FindBulletinBoardQuery fromJson(String json) {
        /*Gen by Vizend Studio v5.1.0*/
        return JsonUtil.fromJson(json, FindBulletinBoardQuery.class);
    }

    public static FindBulletinBoardQuery sample() {
        //
        return new FindBulletinBoardQuery(BulletinBoardCdo.sample().genId());
    }
