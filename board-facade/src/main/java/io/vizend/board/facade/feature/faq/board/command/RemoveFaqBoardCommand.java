...
@AllArgsConstructor
@NoArgsConstructor
public class RemoveFaqBoardCommand extends CommandRequest {
    //
    ...
    public static RemoveFaqBoardCommand fromJson(String json) {
        /*Gen by Vizend Studio v5.1.0*/
        return JsonUtil.fromJson(json, RemoveFaqBoardCommand.class);
    }

    public static RemoveFaqBoardCommand sample() {
        //
        return new RemoveFaqBoardCommand(FaqBoardCdo.sample().genId());
    }
